...
resource "aws_lambda_permission" "lamda_api_permissions_games" {
  ...
  source_arn = "arn:aws:execute-api:us-east-1:228573559958:${aws_api_gateway_rest_api.clue-backend.id}/*/${aws_api_gateway_method.api_method_games.http_method}${aws_api_gateway_resource.api_resource_games.path}"
}